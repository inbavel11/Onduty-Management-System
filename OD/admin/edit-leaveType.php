<?php
    ...
    $msg="OD Type updated successfully";
    ...
    <div class="page-container">
        ...
        <div class="sidebar-menu">
            <div class="sidebar-header">
                <div class="logo">
                    <a href="dashboard.php"><img src="../assets/images/icon/rec.png" alt="logo"></a>
                </div>
            </div>
            <div class="main-menu">
                        ...
                        <?php if($error){?><div class="alert alert-danger alert-dismissible fade show"><strong>Info: </strong><?php echo htmlentities($error); ?>
                                <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                 ...
                                 <div class="card-body">
                                        ...
                                        <p class="text-muted font-14 mb-4">Please make changes on the form below in order to update OD Type</p>
                                        ...
                                        <div class="form-group">
                                            <label for="example-text-input" class="col-form-label">OD Type</label>
