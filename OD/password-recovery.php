...
<body>
    ...
    <div class="login-area login-s2"style="background-image: url('../recod/assets/images/rec1.jpg'); background-size: cover;">
        <div class="container">
            ...
            <div class="login-box ptb--100">
                ...
                <form method="POST" name="signin">
                    <div class="login-form-head">
                        ...
                        <p>Please provide your  details for recovery.</p>
                    </div>
